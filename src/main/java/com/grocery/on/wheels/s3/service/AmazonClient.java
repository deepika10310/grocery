...
public class AmazonClient {
	...
	private void initializeAmazon() {
		// SMPB
		AWSCredentials credentials = new BasicAWSCredentials("AKIAJBGU2DKC7AFB33AQ",
				"mcqcl1Fe0h2fDUHeUxxD4/kMqPYaw5B0h5tYpgF4");
	...
	private void uploadFileTos3bucket(String fileName, File file) {
		// SMPB
		s3client.putObject(new PutObjectRequest("smpbtestproblemsupload", fileName, file)
				.withCannedAcl(CannedAccessControlList.PublicRead));
	...
	public String uploadFile(MultipartFile multipartFile) {
		...
		try {
			...
			// SMPB
			fileUrl = "http://s3.ap-south-1.amazonaws.com" + "/" + "smpbtestproblemsupload" + "/" + fileName;
